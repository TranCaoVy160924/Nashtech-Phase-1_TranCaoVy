        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OnlineShops_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoodPicture = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UserRate = table.Column<int>(type: "int", nullable: false),
                    NumberInStorage = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Goods_OnlineShops_OnlineShopId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Goods_OnlineShopId",
                table: "Goods",
                column: "OnlineShopId");

            migrationBuilder.CreateIndex(
                name: "IX_OnlineShops_OwnerId",
                table: "OnlineShops",
                column: "OwnerId",
                unique: true);
